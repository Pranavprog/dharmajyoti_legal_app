...
const interactiveLegalGuidancePrompt = ai.definePrompt({
  ...
  Your job is to:
  If the user has provided a document, your answers MUST be based on the content of that document.
  If no document is provided, ask step-by-step questions to understand the legal problem, agreement, or concern.
