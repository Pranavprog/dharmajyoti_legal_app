...
const InteractiveLegalGuidanceInputSchema = z.string().describe('The user question or statement.');
export type InteractiveLegalGuidanceInput = z.infer<typeof InteractiveLegalGuidanceInputSchema>;

const InteractiveLegalGuidanceOutputSchema = z.string().describe('The legal guidance generated by the AI.');
export type InteractiveLegalGuidanceOutput = z.infer<typeof InteractiveLegalGuidanceOutputSchema>;

export async function interactiveLegalGuidance(input: InteractiveLegalGuidanceInput): Promise<InteractiveLegalGuidanceOutput> {
